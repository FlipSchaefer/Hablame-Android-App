...
public class ConversationService extends Service implements Speechy.SpeechyCallback, Texty.TextyCallback {
    ...
    public void onCreate() {
        ...
        this.openGAME = new Intent(getApplicationContext(), GameActivity.class);
        this.openGAME.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
    }
    ...
    private boolean startAnotherActivity(final String text) {
        ...
        if (text.toLowerCase().contains(GameActivity.BUZZWORD_RPS.toLowerCase())) {
            rps = true;
        }
